...
class Training(object):
    ...
    def __init__(self, batch_size,nb_epoch,load_model_resume_training=None):
        ...
        if load_model_resume_training is not None:
            self.model =load_model(load_model_resume_training,custom_objects={'generate_dice_loss': generate_dice_loss,'dice_whole_metric':dice_whole_metric,'dice_core_metric':dice_core_metric,'dice_en_metric':dice_en_metric})
